...
<label for="<?php echo esc_attr( $key ); ?>">
    <input type="text" class="wpcpo-option-field wpcpo-time-picker" name="<?php echo esc_attr( $key . '[value]' ); ?>"
           id="<?php echo esc_attr( $key ); ?>"
            <?php echo esc_attr( $field['required'] ? 'required' : '' ); ?>
           data-format="<?php echo esc_attr( Wpcpo_Frontend::js_datetime_format( apply_filters( 'wpcpo_time_format', $field['format'], $field ) ) ); ?>"
