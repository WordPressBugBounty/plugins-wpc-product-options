...
<label for="<?php echo esc_attr( $key ); ?>">
    <input type="text" class="wpcpo-option-field wpcpo-date-time-picker"
           name="<?php echo esc_attr( $key . '[value]' ); ?>"
           id="<?php echo esc_attr( $key ); ?>"
            <?php echo esc_attr( $field['required'] ? 'required' : '' ); ?>
           data-date_format="<?php echo esc_attr( Wpcpo_Frontend::js_datetime_format( apply_filters( 'wpcpo_date_format', $field['date_format'], $field ) ) ); ?>"
           data-time_format="<?php echo esc_attr( Wpcpo_Frontend::js_datetime_format( apply_filters( 'wpcpo_time_format', $field['time_format'], $field ) ) ); ?>"
