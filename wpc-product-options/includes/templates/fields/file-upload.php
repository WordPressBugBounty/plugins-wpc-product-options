...
<div class="wpcpo-item-line">
    ...
    <label><input type="text" class="input-block"
                  name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][filetypes]' ); ?>"
                  value="<?php echo esc_attr( Wpcpo_Backend::upload_filetypes( $this->get_field_value( 'filetypes' ) ) ); ?>"></label>
...
<div class="wpcpo-item-line">
    ...
    <label><?php esc_html_e( 'Min', 'wpc-product-options' ); ?>
        <input type="number" step="1"
               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][size_min]' ); ?>"
               value="<?php echo esc_attr( $this->get_field_value( 'size_min' ) ); ?>"></label>
    <label><?php esc_html_e( 'Max', 'wpc-product-options' ); ?>
        <input type="number" step="1"
               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][size_max]' ); ?>"
               value="<?php echo esc_attr( $this->get_field_value( 'size_max' ) ); ?>"></label>
</div>
<div class="wpcpo-item-line">
    <label>
