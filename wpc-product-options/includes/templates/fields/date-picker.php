...
?>
    ...
    <div class="wpcpo-item-line">
        <input type="checkbox" value="1"
               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block]' ); ?>" <?php checked( $this->get_field_value( 'block', '0' ), '1' ); ?>> <?php esc_html_e( 'Block dates', 'wpc-product-options' ); ?>
                ...
                <li>
                    <label>
                        <input type="checkbox" value="monday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'monday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Monday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="monday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'tuesday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Tuesday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="wednesday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'wednesday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Wednesday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="thursday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'thursday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Thursday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="friday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'friday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Friday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="saturday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'saturday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Saturday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="sunday"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'sunday', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Sunday', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="past"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'past', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Past dates', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="future"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'future', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Future dates', 'wpc-product-options' ); ?>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox" value="selected"
                               name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][block_dates][]' ); ?>" <?php echo esc_attr( in_array( 'selected', $block_dates ) ? 'checked' : '' ); ?>> <?php esc_html_e( 'Selected dates', 'wpc-product-options' ); ?>
                    </label>
                    <input type="text" value="<?php echo esc_attr( $this->get_field_value( 'selected_dates', '' ) ); ?>"
                           name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][selected_dates]' ); ?>"
                           class="wpcpo-multiple-dates" readonly/>
                </li>
            </ul>
        </div>
    </div>
